...
export default function HeroSection({
  ...
  return (
    ...
    >
      ...
      >
        {/* Main Notebook Sheet */}
        <div className="relative bg-[#FFFDF8] dark:bg-[#1A1A1C] border-2 border-stone-300 dark:border-stone-700/80 rounded-lg p-6 sm:p-12 notebook-shadow paper-lines relative">
          
          {/* Top Paper Tape */}
          <div className="absolute -top-3 left-12 w-32 h-7 bg-amber-200/80 dark:bg-amber-900/60 border border-amber-300/80 dark:border-amber-700/60 rotate-[-2deg] shadow-sm flex items-center justify-center font-handwritten text-xs text-amber-950 dark:text-amber-200">
            Page #01 — Intro Log
          </div>
          ...
          <div className="absolute -top-6 -right-3 sm:right-8 w-40 sm:w-48 p-3 bg-amber-100 dark:bg-amber-950/80 border border-amber-300 dark:border-amber-800 text-amber-950 dark:text-amber-100 rotate-3 sticky-shadow font-handwritten text-sm rounded-sm hidden sm:block wiggle-hover">
          ...
          <div className="min-h-[140px] sm:min-h-[160px] mb-8">
            <h1 className="font-heading text-3xl sm:text-5xl lg:text-6xl text-stone-900 dark:text-stone-100 leading-tight">
              {displayedText}
              <span
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-stone-300/80 dark:border-stone-800 font-handwritten text-lg sm:text-xl text-stone-800 dark:text-stone-200">
            <div className="space-y-3">
              <p className="flex items-start gap-2">
                <span className="text-blue-600 dark:text-blue-400 font-bold">➢</span>
                <span>Crafting web apps with <strong className="text-stone-900 dark:text-stone-100 font-heading">React.js, Next.js 16, Node.js & PostgreSQL</strong>.</span>
              </p>
              <p className="flex items-start gap-2">
                <span className="text-blue-600 dark:text-blue-400 font-bold">➢</span>
                <span>Based in <strong className="text-stone-900 dark:text-stone-100">Kanpur, India</strong> with a passion for REST APIs and smooth UI/UX.</span>
              </p>
            </div>
            ...
            <div className="space-y-3">
              <p className="flex items-start gap-2">
                ...
                <span>Mobile development experience in <strong className="text-stone-900 dark:text-stone-100">Flutter & Dart</strong>.</span>
              </p>
              <p className="flex items-start gap-2">
                <CheckCircle2 className="w-5 h-5 text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5" />
                <span>Leadership experience as <strong className="text-stone-900 dark:text-stone-100 font-heading">Founder @ Catalyst Crew</strong> & Tech Head @ Logix Club.</span>
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 pt-6 flex flex-wrap items-center justify-between gap-4 border-t border-dashed border-stone-300 dark:border-stone-800">
            ...
            <div
              ...
              className="cursor-pointer group flex items-center gap-3 bg-stone-100 dark:bg-stone-900/90 px-4 py-2 rounded-full border border-stone-300/80 dark:border-stone-700 hover:border-amber-500 transition-all"
            >
              ...
              <span className="font-handwritten text-sm text-stone-800 dark:text-stone-200">
            ...
            <div
              ...
              className="cursor-pointer group flex items-center gap-2 bg-stone-100 dark:bg-stone-900/90 px-4 py-2 rounded-full border border-stone-300/80 dark:border-stone-700 hover:border-blue-500 transition-all"
            >
      ...
      <div className="mt-12 text-center flex flex-col items-center gap-2 animate-bounce">
        <span className="font-heading text-xl text-stone-700 dark:text-stone-300">
          Keep Scrolling
        </span>
