...
export default function ProjectsSection() {
  ...
  return (
    <section id="projects" className="w-full h-full">
      {/* Notebook Desk Container - 100% Equal Fixed Size */}
      <div className="w-full h-full bg-[#FFFDF8] dark:bg-[#161618] border-2 border-stone-300 dark:border-stone-700/80 rounded-lg p-4 sm:p-8 notebook-shadow paper-grid relative text-stone-900 dark:text-stone-100 flex flex-col justify-between overflow-hidden">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="font-handwritten text-stone-600 dark:text-stone-300 text-[11px] sm:text-xs">
                Sticky Notes Desk — Click any note to unfold full details
              </p>
            </div>
          </div>
        </div>
